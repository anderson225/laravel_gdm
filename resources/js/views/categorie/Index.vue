<template>
    <div>
        <h1 class="h5 mb-4 text-primary text-uppercase">Catégorie</h1>

        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 text-primary text-uppercase">Liste des categories</h6>
            </div>
            <div class="card-body">
                <div>
                    <div class="row">
                        <div class="col-sm-12">
                            <el-table ref="table" v-loading="isRequestOngoing" :data="categories" stripe border fit
                                      style="width: 100%">
        ...
        async deleteCat(id) {
            ...
            this.$swal.fire({
                ...
                if (result.isConfirmed) {
                    window.axios.delete(`/api/auth/categorie/${id}`).then(function (response) {
                       vm.fetchData()
                    })
                }
            })
